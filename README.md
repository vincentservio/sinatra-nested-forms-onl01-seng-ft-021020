...
Pirate Name: <input type="text" name="piratd[name]">
Pirate Weight: <input type="text" name="piratd[weight]">
Pirate Height: <input type="text" name="piratd[height]">
  <input type="submit">




     renders the pirate input fields for name, weight, and height attributes on the page (FAILED - 1)
    renders the first ship's input fields for the name, type, and booty attributes on the page (FAILED - 2)
    renders the second ship's input field for the name, type, and booty attributes on the page (FAILED - 3)
  POST '/pirates'
    returns a 200 status code (FAILED - 4)
    displays the pirate information upon form submission (FAILED - 5)
    displays the first ship's information upon form submission (FAILED - 6)
    displays the second ship's information upon form submission (FAILED - 7)
